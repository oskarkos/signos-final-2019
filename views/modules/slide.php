<section id="carrusel-signos">
    ...
    <div class="padre-texto">
        <div class="texto">
            <h2> Somos una <strong><span style="color: #29ABE2"> productora</span></strong> de contenido, especializada en animación 3D, <strong><span style="color: #29ABE2"> captura de movimiento</span></strong> y realidades <strong><span style="color: #29ABE2">extendidas.</span></strong></h2></div>
    </div>
    <!---- FinFrase ---->
